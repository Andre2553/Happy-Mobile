      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleOpenGoogleMapRoutes} style={styles.routesContainer}>
            <Text style={styles.routesText}>Look at the directions on Google Maps</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.scheduleContainer}>
          ...
          {orphanage.open_on_weekends ? (
            <View style={[styles.scheduleItem, styles.scheduleItemGreen]}>
              ...
              <Text style={[styles.scheduleText, styles.scheduleTextGreen]}>We work on weekends</Text>
            </View>
          ) : (
            <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
              <Feather name="info" size={40} color="#FF669D" />
              <Text style={[styles.scheduleText, styles.scheduleTextRed]}>We don't work on weekends</Text>
            </View>
          )}
